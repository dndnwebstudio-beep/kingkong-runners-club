...
const CONTENT_KEYS = ["products", "notices", "newsletters", "runnersVoice", "schedules"];
...
function normalizeContent(input) {
  ...
  return CONTENT_KEYS.reduce((content, key) => {
    content[key] = Array.isArray(source[key]) ? cloneData(source[key]) : cloneData(defaultContent[key]);
    return content;
  }, {});
}
